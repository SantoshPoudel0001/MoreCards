  ...
  const data = [
    ...
    },
    {
      ...
      extra: [
        ...
        {
          greet:
            "Free .COM/.NET.ORG Domain,(Rs. 4999.00/yr value) - 1 year",
          bg: "bg-[#206EAD]",
          text: "text-white",
        },
      ],
    ...
    <div className="container">
      <div className="text-center container my-12">
        <h1 className="text-3xl pb-2 font-montserrat text-[40px] font-bold">
          Choose Your <span className="text-[#206EAD]"> Zoho CRM </span> Plan
        </h1>
      ...
      <div className="grid md:grid-cols-4 grid-cols-2 mt-6 border">
        {data.map((data, index) => (
          <div className="text-sm pt-12 border pb-6 pl-4" key={index}>
            ...
            <p className="text-sm pb-6 font-dmsans text-[12.6]">
              {data.description}
            </p>
            <span className="font-bold text-sm font-dmsans">RS</span>
            <span className="font-bold font-dmsans text-4xl ">
              {" "}
            ...
            <div className="my-2">
              <span className="bg-[#206EAD] text-white font-dmsans">
                {data.term}
              </span>
            </div>
            ...
            <ul className="text-sm text-gray-800 mt-4 p-6">
              {data.features.map((feature, i) => (
                <li className="p-2" key={i}>
                  <span className="text-green-500 mr-2 font-dmsans text-[12.6px] font-light">
                    &#10004;
                  </span>
                  {feature}
                </li>
